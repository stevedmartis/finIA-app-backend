...
export class ArticleService {
    ...
    async updateArticlePut(id: string, createArticleDto: CreateArticleDto): Promise<Article | null> {
        // Utiliza findOneAndUpdate con la opción new: true para obtener el documento actualizado
